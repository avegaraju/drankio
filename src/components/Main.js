    ...
    <div>
          ...
          <div class="row d-flex">
            <div class="col-lg-6 text order-2 order-lg-1">
              ...
              <div class="CTA">
                <a
                  href="#features"
                  class="btn btn-primary btn-shadow btn-gradient link-scroll"
                >
                  Discover More
                </a>
            ...
            <div class="col-lg-8 text-center">
              ...
              <div class="browser-mockup">
                <div id="nav-tabContent" class="tab-content">
                  ...
                  >
                    <img src="img/preview-3.png" alt="..." class="img-fluid" />
                  </div>
                  <div
                    id="nav-second"
                    role="tabpanel"
                    ...
                    class="tab-pane fade"
                  >
                    <img src="img/preview-2.png" alt="..." class="img-fluid" />
                  </div>
                  <div
                    id="nav-third"
                    role="tabpanel"
                    ...
                    class="tab-pane fade"
                  >
                    <img src="img/preview-1.png" alt="..." class="img-fluid" />
                  </div>
                </div>
              </div>
            </div>
          ...
          <div id="myTab" role="tablist" class="nav nav-tabs">
            <div class="row">
              <div class="col-md-4">
                ...
                >
                  {" "}
                  <span class="number">1</span>Choose any website to turn into
                  an interactive pinboard for feedback
                </a>
              </div>
              <div class="col-md-4">
                <a
                ...
                >
                  {" "}
                  <span class="number">2</span>Choose any website to turn into
                  an interactive pinboard for feedback
                </a>
              </div>
              <div class="col-md-4">
                ...
                >
                  {" "}
                  <span class="number">3</span>Choose any website to turn into
                  an interactive pinboard for feedback
                </a>
              </div>
            </div>
      ...
      <section id="about-us" class="about-us bg-gray">
        <div class="container">
          ...
          <a href="#" class="btn btn-primary btn-shadow btn-gradient">
            Discover More
          </a>
        </div>
      </section>
        ...
        <div class="container">
          <div class="row d-flex align-items-center">
            <div class="text col-lg-6 order-2 order-lg-1">
              <div class="icon">
                <img src="img/medal.svg" alt="..." class="img-fluid" />
              </div>
          ...
          <div class="row d-flex align-items-center">
            ...
            <div class="text col-lg-6">
              <div class="icon">
                <img src="img/hourglass.svg" alt="..." class="img-fluid" />
              </div>
              <h4>Your peace of mind is our business</h4>
              <p>
                There are many variations of passages of Lorem Ipsum available,
          ...
          <div class="row d-flex align-items-center">
            <div class="text col-lg-6 order-2 order-lg-1">
              <div class="icon">
                <img src="img/cup.svg" alt="..." class="img-fluid" />
              </div>
              <h4>Your peace of mind is our business</h4>
              <p>
                There are many variations of passages of Lorem Ipsum available,
          ...
          <div class="owl-carousel owl-theme testimonials-slider">
            <div class="item-holder">
              <div class="item">
                ...
                <div class="text">
                  <div class="quote">
                    <img src="img/quote.svg" alt="..." class="img-fluid" />
                  </div>
                  <p>
